    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "glass group/sidebar-wrapper flex min-h-svh w-full rounded-3xl shadow-2xl p-4 border-none",
            className,
          )}
          {...props}
        >
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="glass text-sidebar-foreground w-[--sidebar-width] p-0 [&>button]:hidden"
          style={
            {
