...
export default async function PublicDashboardPage() {
  try {
    ...
    let donationRes, expenseRes;
    try {
      [donationRes, expenseRes] = await Promise.all([
        supabase
          .from("donations")
      ...
      return (
        <div className="p-6 max-w-2xl w-full mx-auto text-center text-red-600">
          ...
          <p className="text-sm mt-2">
            {donationRes.error?.message || expenseRes.error?.message}
          </p>
        </div>
      );
    }
    ...
    console.error("PublicDashboardPage runtime error:", error);
    return (
      <div className="p-6 max-w-2xl w-full mx-auto text-center text-red-600">
        <p>Something went wrong rendering the public dashboard.</p>
